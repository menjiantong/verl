...
torchrun --nproc_per_node=8 --master_port=59531 scripts/dsv41_consistency/dump_trainer_stages.py \
  --model-path /mnt/share/m00899630/weights/DeepSeek-V4.1-Flash-4layer-scaled32 \
  --out-dir /mnt/share/m00899630/dsv41/dump/trainer --sparse-flash-attn --force-cmp-mask-mode-3 --out-tag _sfa --lengths 64,200
