...
torchrun --nproc_per_node=8 --master_port=59541 scripts/dsv41_consistency/dump_trainer_stages.py \
  --model-path /mnt/share/m00899630/weights/DeepSeek-V4.1-Flash-4layer-scaled32 \
  --out-dir /mnt/share/m00899630/dsv41/dump/trainer --fp32-attention --out-tag _fp32 --lengths 64,200
